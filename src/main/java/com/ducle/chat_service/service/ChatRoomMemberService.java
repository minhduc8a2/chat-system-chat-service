...
public class ChatRoomMemberService {
        ...
        public Page<BasicUserInfoDTO> getChatRoomMembers(Long chatRoomId, Long userId, int page, int size,
                        String sortBy,
                        String sortDir) {
        ...
        public void updateLastSeenTimeStamp(Long chatRoomId, Long memberId, Instant lastSeenTimeStamp) {
                ...
                member.setLastSeen(lastSeenTimeStamp);
